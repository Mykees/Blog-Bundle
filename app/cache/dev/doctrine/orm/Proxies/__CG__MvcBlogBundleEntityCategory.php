...
namespace Proxies\__CG__\Mvc\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Mvc\BlogBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mvc\\BlogBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Mvc\\BlogBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Mvc\\BlogBundle\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'Mvc\\BlogBundle\\Entity\\Category' . "\0" . 'posts');
        }
